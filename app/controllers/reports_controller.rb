...
class ReportsController < ApplicationController
  ...
  def open_closed_operations
    ...
    # opening closed operation
    JournalOperation.where(:company_id => current_user.current_company).where(:closed_operation_id => params[:closed_op_id]).each do |jo|
      jo.closed_operation_id = nil
      jo.save
    end
